...
{
    /// <summary> 
    /// Базовый класс для модулей бизнес логики.
    /// </summary>
    public class BaseUnit
    {
        ...
        public BaseUnit()
        {
            _contextFactory = IoC.Instance.Resolve<IDataContextFactory>();
            _connectionString = ConfigurationManager.ConnectionStrings["GlobalPrint"].ConnectionString;
        }

        /// <summary> 
        /// Create a data connection context. Opens the connection to DB.
        /// </summary>
        ...
        /// <summary> 
        /// Create a typed repository by its interface.
        /// </summary>
