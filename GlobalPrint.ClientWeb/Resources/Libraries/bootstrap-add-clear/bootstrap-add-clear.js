...
;(function($, window, document, undefined) {
  ...
  Plugin.prototype = {
    ...
    init: function() {
      ...
      $this.after($("<span class='add-clear-x form-control-feedback " + options.symbolClass + "' style='display: none; z-index: 3;'>" + options.closeSymbol + "</span>"));
      $this.next().css({
        'color': options.color,
        'cursor': 'pointer',
      ...
      $this.siblings(".add-clear-x").on('click.addclear', function(e) {
        $(this).siblings(me.element).val(null);
        $(this).hide();
